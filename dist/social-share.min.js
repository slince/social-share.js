...
var Provider = function () {
    ...
    (0, _createClass3.default)(Provider, [{
        ...
        value: function _createDomNode() {
            var html = '<a href="javascript:void(0)" class="social-share-button social-share-' + this.getName() + '"><i class="' + this.options.iconClass + '"></i> </a>';
        ...
        value: function _createUrl() {
            ...
            return urlTemplate.replace(/\{\{(\w+)\}\}/g, function (matches) {
                var parameter = matches.slice(2, -2);
        ...
        value: function _bindEvents(element) {
            ...
            element.on('click', function () {
                var win = util.openWin(_this._createUrl(), _this.options.width, _this.options.height);
                win.focus();
            });
        }
    }]);
    ...
    (0, _createClass3.default)(SocialShare, [{
        ...
        value: function _createProviders() {
            ...
            for (var provider in this.options) {
                var instance = this._createProvider(provider, this.options[provider]);
        ...
        key: '_createProvider',
        value: function _createProvider(provider, options) {
            if (!options.title) {
            ...
            var providerClass = this.providerClassMap[provider];
            var instance = new providerClass(options);
            return instance;
        }
    }]);
    return SocialShare;
...
var QQ = function (_Provider) {
    ...
    function QQ() {
        ...
        return (0, _possibleConstructorReturn3.default)(this, (QQ.__proto__ || (0, _getPrototypeOf2.default)(QQ)).apply(this, arguments));
    }
...
var QZone = function (_Provider) {
    ...
    function QZone() {
        ...
        return (0, _possibleConstructorReturn3.default)(this, (QZone.__proto__ || (0, _getPrototypeOf2.default)(QZone)).apply(this, arguments));
    }
